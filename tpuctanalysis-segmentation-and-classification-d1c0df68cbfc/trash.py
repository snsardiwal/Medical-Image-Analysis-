...
dicom_path = "/Users/sachin/Desktop/CT_Project/images/dicomImages/patient1/time1/aftNorm/000.png"
im=Image.open(dicom_path).convert('L')
im=np.array(im)
im1=region_growing(im,(0,0))
